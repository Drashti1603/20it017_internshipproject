                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            {
                                $course_id = $_GET['id'];
                                $users = "SELECT * from subject where id = '$course_id'";
                                ...
                                if(mysqli_num_rows($users_run)>0)
                                {
                                    ...
                                    {
                                    ?>
                                    <form action="subcode.php" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <button type="submit" name="update_course" class="btn btn-primary">Edit Course</button>
                                            </div>
                                        </div>
                                    </form>
                                    <?php

...
<head>
    ...
    <link href="http://localhost/online%20exam%20system/admin/manageAccount/editprofile/ep.css" rel="stylesheet"/>
...
<body class="w3-light-grey">
    ...
    <div id="topBar" class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <span class="w3-bar-item w3-right"><form action="/Account/LogOff" class="navbar-right" id="logoutForm" method="post"><input name="__RequestVerificationToken" type="hidden" value="3QYdXBCO9uuotu_qD_ykm9eEfm7um3E_1aE5ew3vOlmdh6OiaQQRD2y_CTTnpDxl-PEYYI7ntsuMMC0lDin6W_vreKltIkW0qVLyXkOi1X58e3ewSwzthBf5cPbMz0rdZs41YJdDxPJsl-i3-Kk1og2" />    <ul style="list-style:none" class="btn btn-menu">
                                        ...
                                        if(mysqli_num_rows($query_run)>0){
                                            foreach($query_run as $row){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['subcode']; ?></td>
                                                    <td><?= $row['date']; ?></td>
                                                    <td><a href="http://localhost/online%20exam%20system/admin/mcqs/questions.php?id=<?=$row['id'];?>" class="btn btn-success">Exam Paper</a></td>

...
<head>
    ...
    <link href="http://localhost/online%20exam%20system/admin/student%20management/stu.css" rel="stylesheet"/>
...
<body class="w3-light-grey">
    ...
    <div id="topBar" class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <span class="w3-bar-item w3-right"><form action="/Account/LogOff" class="navbar-right" id="logoutForm" method="post"><input name="__RequestVerificationToken" type="hidden" value="OHlDh59N4f709dJ2PfRWqgBF_qy5twID7Tm442W8j7weRnQmvzD6VPT5Gs2H79Qdtj4jmUp_y-gh09kk09KJeapv9K3z6naSK94nPXvyFH5wfxS5cOdoW1Di6hNcePWkvWqg26j8OizU5EZ61fXStg2" />    <ul style="list-style:none" class="btn btn-menu">
...
admin                    </strong>
        ...
        <div class="w3-bar-block">
            ...
            <a class="w3-bar-item w3-button w3-padding w3-blue" href="http://localhost/online%20exam%20system/admin/student%20management/stu.php"><i class="fa fa-child"></i> Student Management</a>
                                        ...
                                        if(mysqli_num_rows($query_run)>0){
                                            foreach($query_run as $row){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['dept']; ?></td>
                                                    <td><?= $row['college']; ?></td>
                                                    <td><a href="http://localhost/online%20exam%20system/admin/student%20management/edit_student.php?id=<?=$row['id'];?>" class="btn btn-success">Edit</a></td>
                                                    <td><a href="http://localhost/online%20exam%20system/admin/student%20management/studelete.php?id=<?=$row['id'];?>" class="btn btn-danger">Delete</a>

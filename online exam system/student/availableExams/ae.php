...
<head>
    ...
    <link href="http://localhost/online%20exam%20system/student/availableExams/ae.css" rel="stylesheet"/>
    <link href="http://localhost/online%20exam%20system/home/home.css" rel="stylesheet"/>
    <link href="http://localhost/online%20exam%20system/student/manageAccount/viewprofile/vp.css" rel="stylesheet"/>
...
<body class="w3-light-grey">
    ...
    <div id="topBar" class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <span class="w3-bar-item w3-right"><form action="/Account/LogOff" class="navbar-right" id="logoutForm" method="post"><input name="__RequestVerificationToken" type="hidden" value="PyDV-LAxIn99Q5-dx81VVb1Vk3YDUs5rjS5jM_Kjq6l2olcHQqoOcW7tSoCKK2M7nDjxnd9xP6LtxhpAXZPNrnAip7o0r-mXhaZ5lRKyK1fzLDCsEd2Il0POcJLAo5p81RZgNOP_gUSWqw360ndjhg2" />    <ul style="list-style:none" class="btn btn-menu">
...
<a class="w3-bar-item w3-button w3-padding " href="http://localhost/online%20exam%20system/student/examrules/e.html"><i class="fa fa-warning"></i><span style="padding-left: 10px;">General Exam Rules</span></a>
<a href="http://localhost/online%20exam%20system/student/availableExams/ae.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-certificate"></i><span style="padding-left:10px;">Available Exams</span></a>
...
<li>
<a href="http://localhost/online%20exam%20system/student/mangementAccount/viewProfile/vp.php" class="w3-bar-item w3-button w3-padding "><i class="fa fa-user"></i><span style="padding-left:10px;">View Profile</span></a>
</li>
                                    ...
                                    if(mysqli_num_rows($query_run)>0){
                                        foreach($query_run as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['subcode']; ?></td>
                                                <td><?= $row['date']; ?></td>
                                                <td><a href="quespaper.pdf" class="btn btn-success">View</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }

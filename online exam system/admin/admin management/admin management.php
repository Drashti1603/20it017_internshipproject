                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    if(mysqli_num_rows($query_run)>0){
                                        foreach($query_run as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['username']; ?></td>
                                                <td><?= $row['password']; ?></td>
                                                <td><a href="http://localhost/online%20exam%20system/admin/manageAccount/editprofile/ep.php?id=<?=$row['id'];?>" class="btn btn-success">Edit</a></td>
                                                <td><a href="http://localhost/online%20exam%20system/admin/admin%20management/delete.php?id=<?=$row['id'];?>" class="btn btn-danger">Delete</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                            ...
                            <a href ="add_register.php" class="btn btn-primary float-end">Add Admin</a>
                        </div>
                    </div>
                </div>
            </div>

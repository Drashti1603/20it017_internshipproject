...
<body class="w3-light-grey">
    ...
    <div id="topBar" class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <li class="menu-item" id="userNameMenu"><i class="glyphicon glyphicon-user"></i> <a href="http://localhost/online%20exam%20system/student/manageAccount/viewprofile/vp.html">student2</a></li>
    </ul>
        <ul style="list-style:none" class="btn btn-menu">
...
<a href="http://localhost/online%20exam%20system/student/announcements/a.html" class="w3-bar-item w3-button w3-padding  w3-blue "><i class="fa fa-bullhorn"></i><span style="padding-left:10px;">Announcements</span></a>
...
<a href="http://localhost/online%20exam%20system/student/availableExams/ae.html" class="w3-bar-item w3-button w3-padding"><i class="fa fa-certificate"></i><span style="padding-left:10px;">Available Exams</span></a>
<a href="http://localhost/online%20exam%20system/student/examHistory/eh.html" class="w3-bar-item w3-button w3-padding "><i class="fa fa-history"></i><span style="padding-left:10px;">Exam History</span></a>
...
<li>
<a href="http://localhost/online%20exam%20system/student/mangementAccount/viewProfile/vp.html" class="w3-bar-item w3-button w3-padding "><i class="fa fa-user"></i><span style="padding-left:10px;">View Profile</span></a>
</li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            {
                                $student_id = $_GET['id'];
                                $users = "SELECT password from student where id = '$student_id'";
